...
import os
path = os.getcwd()
new_model_path = os.path.join(path, '../onnx_generated_models/onnx-ReduceMax.onnx')
...
model_path1 = os.path.join(path, '../onnx_generated_models/onnx-ReduceMax.onnx')
...
import numpy as np
sess = rt.InferenceSession("../onnx_generated_models/onnx-ReduceMax.onnx")
