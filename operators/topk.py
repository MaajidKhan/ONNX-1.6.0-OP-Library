...
import os
path = os.getcwd()
new_model_path = os.path.join(path, '../onnx_generated_models/topk.onnx')
onnx.save(model_def, new_model_path)
print('The model is saved.')


# Preprocessing: load the ONNX model (Loading an already exisisting model)
model_path1 = os.path.join(path, '../onnx_generated_models/topk.onnx')
...
import numpy
sess = rt.InferenceSession("../onnx_generated_models/topk.onnx")
