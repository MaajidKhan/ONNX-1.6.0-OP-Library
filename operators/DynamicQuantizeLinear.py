...
import os
path = os.getcwd()
new_model_path = os.path.join(path, '../onnx_generated_models/onnx-DynamicQuantizeLinear.onnx')
...
model_path1 = os.path.join(path, '../onnx_generated_models/onnx-DynamicQuantizeLinear.onnx')
onnx_model1 = onnx.load(model_path1)

print('The model is:\n{}'.format(onnx_model1))

import onnxruntime as rt
sess = rt.InferenceSession("../onnx_generated_models/onnx-DynamicQuantizeLinear.onnx")
