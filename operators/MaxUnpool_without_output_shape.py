#MaxUnpool (without_output_shape)
import onnx
...
model_path1 = os.path.join(path, '../onnx_generated_models/onnx-MaxUnpool.onnx')
onnx_model1 = onnx.load(model_path1)

print('The model is:\n{}'.format(onnx_model1))

import onnxruntime as rt
sess = rt.InferenceSession("../onnx_generated_models/onnx-MaxUnpool.onnx")
...
print("The predicted output for the operation: MaxUnpool (without_output_shape)", y_pred)
