...
import os
path = os.getcwd()
new_model_path = os.path.join(path, 'onnx-ReduceSumSquare.onnx')
...
model_path1 = os.path.join(path, 'onnx-ReduceSumSquare.onnx')
...
import numpy as np
sess = rt.InferenceSession("onnx-ReduceSumSquare.onnx")
