...
import os
path = os.getcwd()
new_model_path = os.path.join(path, 'onnx-ConvTranspose.onnx')
...
model_path1 = os.path.join(path, 'onnx-ConvTranspose.onnx')
...
import numpy as np
sess = rt.InferenceSession("onnx-ConvTranspose.onnx")
