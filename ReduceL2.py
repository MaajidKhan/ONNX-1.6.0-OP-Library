#ReduceL2(default_axes_keepdims)
...
import os
path = os.getcwd()
new_model_path = os.path.join(path, 'onnx-reduceL1.onnx')
...
model_path1 = os.path.join(path, 'onnx-reduceL1.onnx')
...
import numpy as np
sess = rt.InferenceSession("onnx-reduceL1.onnx")
